...
public static class ProcessorHelper
{
    ...
    public static IEnumerable<string> GetMatchingKeys(
        this IEnumerable<string> options,
        IDictionary<string, object> flattened)
    {
    ...
    public static IDictionary<string, string> GetMatchingMaps(
        this IDictionary<string, string> maps,
        IDictionary<string, object> flattened,
        bool keyOnly = false)
    {
